...
class Kines(models.Model):
    name = models.CharField(max_length=1100, blank=True, null=True)
    phone = models.CharField(max_length=1100, blank=True, null=True)
    description = models.CharField(max_length=1100, blank=True, null=True)
    distrito = models.ForeignKey('Distrito', models.DO_NOTHING, db_column='distrito', blank=True, null=True)
